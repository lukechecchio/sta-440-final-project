...
firenze_coef |> kable(col.names = c("Variable", "Estimate", "Std. Error", "Statistic"))
```
...
milano_coef |> kable(col.names = c("Variable", "Estimate", "Std. Error", "Statistic"))
```
...
napoli_coef |> kable(col.names = c("Variable", "Estimate", "Std. Error", "Statistic"))
```
...
rownames(roma_coef) <- c("Intercept", "Max. Guests", "Avg. Review Score", "Room Type | Hotel", "Room Type | Private", "Room Type | Shared",
                         "Superhost Status", "Relative Latitude", "Relative Longitude", "Season | Spring", "Season | Summer", "Season | Winter")
roma_coef <- as.data.frame(roma_coef) |> round(3) |> rownames_to_column("Variable")


roma_coef |> kable(col.names = c("Variable", "Estimate", "Std. Error", "Statistic"))
```
...
venezia_coef |> kable(col.names = c("Variable", "Estimate", "Std. Error", "Statistic"))
```
