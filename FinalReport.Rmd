...
opts_chunk$set(echo = F, warning = F, message = F, fig.width = 8, fig.height = 6, fig.show = "asis",
               out.width = "5in", fig.align = 'center')
```
...
Exploratory analysis was conducted on several additional variables deemed important for model fitting, although not necessarily relevant to the research question itself. These plots are included in the Appendix.
...
firenze_coef |> kable(col.names = c("Variable", "Estimate", "Std. Error", "Statistic"), caption = "Florence Model Fixed Effects")
```
...
milano_coef |> kable(col.names = c("Variable", "Estimate", "Std. Error", "Statistic"), caption = "Milan Model Fixed Effects")
```
...
napoli_coef |> kable(col.names = c("Variable", "Estimate", "Std. Error", "Statistic"), caption = "Naples Model Fixed Effects")
```
...
roma_coef |> kable(col.names = c("Variable", "Estimate", "Std. Error", "Statistic"), caption = "Rome Model Fixed Effects")
```
...
venezia_coef |> kable(col.names = c("Variable", "Estimate", "Std. Error", "Statistic"), caption = "Venice Model Fixed Effects")
```
...
* Baayen, R.H., et al. “Mixed-effects modeling with crossed random effects for subjects and items.” Journal of Memory and Language, vol. 59, no. 4, Nov. 2008, pp. 390–412, [https://doi.org/10.1016/j.jml.2007.12.005](https://doi.org/10.1016/j.jml.2007.12.005). 

* Bashir, Umair. “Hotel / Private Accommodation Online Bookings by Brand in Italy 2024.” Statista, 23 Oct. 2024, [www.statista.com/forecasts/1000846/hotel-private-accommodation-online-bookings-by-brand-in-italy](www.statista.com/forecasts/1000846/hotel-private-accommodation-online-bookings-by-brand-in-italy).

* “Linear Mixed Effect Models.” University of St. Andrews, [https://www.st-andrews.ac.uk/media/ceed/students/mathssupport/mixedeffectsknir.pdf](https://www.st-andrews.ac.uk/media/ceed/students/mathssupport/mixedeffectsknir.pdf).

* Marcello, Salvatore. "Italian Airbnb Dataset." Inside Airbnb, 17 Sep. 2024, [https://www.kaggle.com/datasets/salvatoremarcello/italian-airbnb-dataset](https://www.kaggle.com/datasets/salvatoremarcello/italian-airbnb-dataset).

* Pederson, Thomas Lin. “Adding Annotation and Style.” Patchwork, 18 Aug. 2022, [patchwork.data-imaginist.com/articles/guides/annotation.html](patchwork.data-imaginist.com/articles/guides/annotation.html). 

* Tufft, Caroline, et al. “Now Boarding: Faces, Places, and Trends Shaping Tourism in 2024.” McKinsey & Company, McKinsey & Company, 29 May 2024, [www.mckinsey.com/industries/travel-logistics-and-infrastructure/our-insights/now-boarding-faces-places-and-trends-shaping-tourism-in-2024](www.mckinsey.com/industries/travel-logistics-and-infrastructure/our-insights/now-boarding-faces-places-and-trends-shaping-tourism-in-2024).

* Xie, Yihui. “Options: Chunk Options and Package Options.” Knitr, 30 June 2020, [yihui.org/knitr/options/#chunk-options](yihui.org/knitr/options/#chunk-options).
...
## Model Assumptions Investigation

### Florence Model

```{r}
#| label: model-checking-firenze-1
#| fig-cap: "Residuals vs. Fitted Values, Florence Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-firenze-2
#| fig-cap: "Residuals Autocorrelation, Florence Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-firenze-3
#| fig-cap: "Residuals QQ Plot, Florence Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-firenze-4
#| fig-cap: "Residuals Density, Florence Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-milano-1
#| fig-cap: "Residuals vs. Fitted Values, Milan Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-milano-2
#| fig-cap: "Residuals Autocorrelation, Milan Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-milano-3
#| fig-cap: "Residuals QQ Plot, Milan Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-milano-4
#| fig-cap: "Residuals Density, Milan Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-napoli-1
#| fig-cap: "Residuals vs. Fitted Values, Naples Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-napoli-2
#| fig-cap: "Residuals Autocorrelation, Naples Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-napoli-3
#| fig-cap: "Residuals QQ Plot, Naples Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-napoli-4
#| fig-cap: "Residuals Density, Naples Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-roma-1
#| fig-cap: "Residuals vs. Fitted Values, Rome Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-roma-2
#| fig-cap: "Residuals Autocorrelation, Rome Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-roma-3
#| fig-cap: "Residuals QQ Plot, Rome Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-roma-4
#| fig-cap: "Residuals Density, Rome Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-venezia-1
#| fig-cap: "Residuals vs. Fitted Values, Venice Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-venezia-2
#| fig-cap: "Residuals Autocorrelation, Venice Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-venezia-3
#| fig-cap: "Residuals QQ Plot, Venice Model"
#| out-width: "3in"
...
```{r}
#| label: model-checking-venezia-4
#| fig-cap: "Residuals Density, Venice Model"
#| out-width: "3in"
