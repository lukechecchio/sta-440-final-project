...
all_rel_lm <- lm(relative_price ~ accommodates + review_scores_rating + room_type + host_is_superhost + period + place + period*place, data = city_data)
firenze_rel_lm <- lm(relative_price ~ accommodates + review_scores_rating + room_type + host_is_superhost + period, data = firenze_data)
